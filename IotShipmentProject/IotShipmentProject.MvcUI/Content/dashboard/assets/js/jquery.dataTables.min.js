    ...
    var L = function (h) {
        var j = function (e) {
            ...
            fnRowCallback: null, fnServerData: function (e, j, m, k) { k.jqXHR = h.ajax({ url: e, data: j, success: function (e) { e.sError && k.oApi._fnLog(k, 0, e.sError); h(k.oInstance).trigger("xhr", [k, e]); m(e) }, dataType: "json", cache: !1, type: k.sServerMethod, error: function (e, h) { "parsererror" == h && k.oApi._fnLog(k, 0, "DataTables warning: JSON data from server could not be parsed. This is caused by a JSON formatting error.") } }) }, fnServerParams: null, fnStateLoad: function (e) {
                ...
                oPaginate: { sFirst: "Baslangic", sLast: "Son", sNext: "Sonraki", sPrevious: "Onceki" }, sEmptyTable: "Veri kaydi bulunamadi", sInfo: "Toplam _TOTAL_ kaydin _START_ dan _END_ ya kadari listelendi", sInfoEmpty: "Veri kaydi bulunamadi", sInfoFiltered: "(_MAX_ adet veri kaydindan filtrelendi)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "Listele _MENU_", sLoadingRecords: "Loading...", sProcessing: "Ýþleniyor...", sSearch: "Search:", sUrl: "", sZeroRecords: "Aramaya dair kayit bulunamadi"
